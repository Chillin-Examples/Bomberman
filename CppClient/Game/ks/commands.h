...
public: // reference getters
	...
	inline EDir &ref_direction() const
	{
		return (EDir&) __direction;
	}
	

public: // setters

	inline void direction(const EDir &direction)
	{
...
public:
	...
	std::string serialize() const
	{
		...
		if (__has_direction)
		{
			unsigned char tmp1 = (unsigned char) __direction;
