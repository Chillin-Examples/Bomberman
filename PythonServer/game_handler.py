...
class MyRealtimeGameHandler(RealtimeGameHandler):
    ...
    def on_initialize_gui(self):
        ...
        self.first_bomberman_ref = list(self.world.bombermans.keys())[0] # refrence to first bomberman
    ...
    def on_update_gui(self):
        print('update gui')
        # Move all Explosions back to bombermans
        for explosion in self.world.explosions:
        	self.canvas.send_to_back(explosion.ref, self.first_bomberman_ref)
